...
<div class="section">
    <form action="/staff/create" method="post">
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" name="funcion" id="" placeholder="Esta funcion se encarga de ...">
            </div>
        </div>    
        <div class="field">
            <label class="label" for="">Descripcion de la funcion:</label>
            <div class="control">
                <textarea class="textarea" name="descripcionFuncion" placeholder="Descripcion de a funcion"></textarea>                
            </div>
        </div>
        <div class="field">
